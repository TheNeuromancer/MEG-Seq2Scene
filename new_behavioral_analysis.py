...
# model_results_2obj["Mismatch on"] = model_results_2obj["Mismatch on"].apply(lambda x: x.capitalize())
# model_results_2obj["Mismatch on detailed"] = model_results_2obj.apply(lambda x: x["Mismatch on"] if x["Mismatch on"]!='Property' else x["Changed property"], axis=1)
...
if prepared_data_path.exists() and not recompute:
	...
	all_subs_md["Complexity"] = all_subs_md["Difficulty"].apply(lambda x: {"D0": 0, "D1": 1, "D2": 2, "L1": None}[x])
	...
	results_2obj["Mismatch on"] = results_2obj["Error_type"].apply(lambda x: {"None": 'None', "l0": 'Property', "l1": 'Binding', "l2": 'Relation'}[x])
	results_2obj["Mismatch on detailed"] = results_2obj.apply(lambda x: {"None": 'None', "l1": 'Binding', "l2": 'Relation'}[x.Error_type] if x.Error_type!='l0' else "Color" if "colour" in x.Change else "Shape", axis=1)
	# one obj
	results_1obj["Mismatch on"] = results_1obj["Error_type"].apply(lambda x: {"None": 'None', "colour": 'Color', "shape": 'Shape'}[x])
...
print("starting")
# print(results_1obj['Error_type'])
# print(results_1obj['Mismatch on'])
# set_trace()
box_pairs = []
...
# ### VIOLATION ON ### 
make_sns_barplot(results_1obj, x='Mismatch on', y='Error rate', kind='point', out_fn=f'{out_dir}/stat_1obj_violon_errorrate_point.png', order=["Shape", "Color"])
make_sns_barplot(results_1obj.query("Perf==1"), x='Mismatch on', y='RT', kind='point', out_fn=f'{out_dir}/stat_1obj_violon_RT_point.png', order=["Shape", "Color"])

# ### SHAPE * VIOLATION ON ###
# make_sns_barplot(results_1obj, x='shape1', y='Error rate', kind='point', hue='Mismatch on', out_fn=f'{out_dir}/stat_1objshape*violon_errorrate_point.png', order=['carre', 'triangle', 'cercle'], hue_order=["Shape", "Color"])
# make_sns_barplot(results_1obj.query("Perf==1"), x='shape1', y='RT', kind='point', hue='Mismatch on', out_fn=f'{out_dir}/stat_1obj_shape*violon_RT_point.png', order=['carre', 'triangle', 'cercle'], hue_order=["Shape", "Color"])

# ### COLOR * VIOLATION ON ###
# make_sns_barplot(results_1obj, x='colour1', y='Error rate', kind='point', hue='Mismatch on', out_fn=f'{out_dir}/stat_1objcolor*violon_errorrate_point.png', order=['rouge', 'vert', 'bleu'], hue_order=["Shape", "Color"])
# make_sns_barplot(results_1obj.query("Perf==1"), x='colour1', y='RT', kind='point', hue='Mismatch on', out_fn=f'{out_dir}/stat_1obj_color*violon_RT_point.png', order=['rouge', 'vert', 'bleu'], hue_order=["Shape", "Color"])
...
make_sns_barplot(results_1obj, x='Mismatch on', y='Error rate', kind='point', dodge=.2, hue='Subject', legend=False, out_fn=f'{out_dir}/stat_1obj_all_subs_violon_errorrate_point.png', order=["Shape", "Color"])
make_sns_barplot(results_1obj.query("Perf==1"), x='Mismatch on', y='RT', kind='point', dodge=.2, hue='Subject', legend=False, out_fn=f'{out_dir}/stat_1obj_all_subs_violon_RT_point.png', order=["Shape", "Color"])
...
local_results_2obj = deepcopy(results_2obj).query("`Mismatch on`=='property'")
local_results_2obj["Mismatch on"] = local_results_2obj["Change"].apply(lambda x: "Color" if "colour" in x else "Shape")
make_sns_barplot(local_results_2obj, x='Mismatch on', y='Error rate', kind='point', out_fn=f'{out_dir}/stat_2obj_violon_prop_errorrate_point.png', order=["Shape", "Color"])
make_sns_barplot(local_results_2obj.query("Perf==1"), x='Mismatch on', y='RT', kind='point', out_fn=f'{out_dir}/stat_2obj_violon_prop_RT_point.png', order=["Shape", "Color"])

## VIOLATION ON
make_sns_barplot(results_2obj, x='Mismatch on', y='Error rate', kind='point', out_fn=f'{out_dir}/stat_2obj_violon_errorrate_point.png', order=["Property", "Binding", "Relation"])
make_sns_barplot(results_2obj.query("Perf==1"), x='Mismatch on', y='RT', kind='point', out_fn=f'{out_dir}/stat_2obj_violon_RT_point.png', order=["Property", "Binding", "Relation"])
...
make_sns_barplot(results_2obj, x='Complexity', y='Error rate', hue='Violation', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_complexity_by_violation_errorrate_point_dodge.png', order=[0, 1, 2])
make_sns_barplot(results_2obj.query("Perf==1"), x='Complexity', y='RT', hue='Violation', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_complexity_by_violation_RT_point_dodge.png', order=[0, 1, 2])

make_sns_barplot(results_2obj, x='Complexity', y='Error rate', hue='Mismatch on', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_complexity_by_violon_errorrate_point_dodge.png', order=[0, 1, 2])
make_sns_barplot(results_2obj.query("Perf==1"), x='Complexity', y='RT', hue='Mismatch on', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_complexity_by_violon_RT_point_dodge.png', order=[0, 1, 2])

make_sns_barplot(results_2obj, x='Complexity', y='Error rate', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_complexity_errorrate_point_dodge.png', order=[0, 1, 2])
make_sns_barplot(results_2obj.query("Perf==1"), x='Complexity', y='RT', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_complexity_RT_point_dodge.png', order=[0, 1, 2])
...
# ### ERROR_TYPE ###
# make_sns_barplot(results_2obj, x='Mismatch on', y='Error rate', kind='point', box_pairs=box_pairs, out_fn=f'{out_dir}/stat_point_2obj_Violon_errorrate.png', order=["None", "property", "binding", "relation"])
# make_sns_barplot(results_2obj.query("Perf==1"), x='Mismatch on', y='RT', kind='point', box_pairs=box_pairs, out_fn=f'{out_dir}/stat_point_2obj_Vilon on_RT.png', order=["None", "property", "binding", "relation"])

# ## SHARED FEATURES BY ERROR TYPE
# make_sns_barplot(results_2obj, x='# Shared features', y='Error rate', hue='Mismatch on', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_#shared_by_Violon_errorrate_point_dodge.png', order=[2, 1, 0], hue_order=["None", "property", "binding", "relation"])
# make_sns_barplot(results_2obj.query("Perf==1"), x='# Shared features', y='RT', hue='Mismatch on', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_#shared_by_Violon_RT_point_dodge.png', order=[2, 1, 0], hue_order=["None", "property", "binding", "relation"])

# ## SHARING BY ERROR TYPE
make_sns_barplot(results_2obj, x='Sharing', y='Error rate', hue='Mismatch on', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_sharing_by_Violon_errorrate_point_dodge.png', order=["Both", "Shape", "Color", "None"], hue_order=["None", "property", "binding", "relation"])
make_sns_barplot(results_2obj.query("Perf==1"), x='Sharing', y='RT', hue='Mismatch on', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_sharing_by_Violon_RT_point_dodge.png', order=["Both", "Shape", "Color", "None"], hue_order=["None", "property", "binding", "relation"])

# make_sns_barplot(results_2obj, x='Mismatch on', y='Error rate', hue='Sharing', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_Violon_by_sharing_errorrate_point_dodge.png', hue_order=["Both", "Shape", "Color", "None"], order=["None", "property", "binding", "relation"])
# make_sns_barplot(results_2obj.query("Perf==1"), x='Mismatch on', y='RT', hue='Sharing', dodge=.2, kind='point', out_fn=f'{out_dir}/stat_Violon_by_sharing_RT_point_dodge.png', hue_order=["Both", "Shape", "Color", "None"], order=["None", "property", "binding", "relation"])
