...
parser.add_argument('-i', '--in-dir', default='Results/Decoding_v7/Epochs/', help='input directory')
...
all_labels = np.unique([op.basename(fn).split('_')[0] for fn in all_filenames])
