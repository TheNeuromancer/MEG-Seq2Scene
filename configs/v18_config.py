...
class Config:
    ...
    max_trials_win: int = 5000 # maximum number of trials (after micro-averaging) for the window decoding analysis 
    ...
    micro_ave: int = False
    max_trials: int = 1000 # maximum number of trials (after micro-averaging)
